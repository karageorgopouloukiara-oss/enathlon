...
export const STR = {
  it: {
    ...
    email: 'Email (facoltativa)', emailHint: 'Ricevi una notifica quando tocca a te e non sei online.', emailBad: 'Email non valida',
  ...
  en: {
    ...
    email: 'Email (optional)', emailHint: "Get notified when it's your turn and you're not online.", emailBad: 'Invalid email',
